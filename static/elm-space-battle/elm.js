...
var $author$project$Main$facePoint = F2(
	function (p, e) {
		var _v0 = p;
		var px = _v0.a;
		var py = _v0.b;
		...
		var ex = _v1.a;
		var ey = _v1.b;
		var theta = A2($elm$core$Basics$atan2, py - ey, px - ex);
		...
		function (r, t) {
			return _Utils_Tuple2(
				r * $elm$core$Basics$cos(
					$elm$core$Basics$degrees(t)),
				r * $elm$core$Basics$sin(
					$elm$core$Basics$degrees(t)));
		});
	var p = {
		position: A2(polar, 400, 135),
		theta: $elm$core$Basics$degrees(45),
		velocity: _Utils_Tuple2(0, 0)
	};
	var e1 = {
		position: A2(polar, 300, 315),
		theta: $elm$core$Basics$degrees(0),
		velocity: _Utils_Tuple2(0, 0)
	};
	var e2 = {
		position: A2(polar, 100, 0),
		theta: $elm$core$Basics$degrees(0),
		velocity: _Utils_Tuple2(0, 0)
	};
	var e3 = {
		position: A2(polar, 200, 0),
		theta: $elm$core$Basics$degrees(0),
		velocity: _Utils_Tuple2(0, 0)
	};
	return {
		enemies: A2(
			$elm$core$List$map,
			$author$project$Main$facePoint(p.position),
			_List_fromArray(
				[e1, e2, e3])),
		player: p,
		state: s,
...
var $author$project$Main$Accelerate = {$: 'Accelerate'};
...
var $author$project$Main$toDirection = function (string) {
	var _v0 = A2($elm$core$Debug$log, 'Pressed:', string);
	switch (string) {
		case 'w':
			return $author$project$Main$Accelerate;
		case 'a':
			return $author$project$Main$Rotate($author$project$Main$Left);
		case 'd':
			return $author$project$Main$Rotate($author$project$Main$Right);
		case 's':
			return $author$project$Main$Shoot;
		case ' ':
			return $author$project$Main$Shoot;
		case 'Enter':
...
var $author$project$Main$clampV = function (_v0) {
	var dx = _v0.a;
	var dy = _v0.b;
	var maxVelocity = 5;
	var toPolar = function (_v2) {
		var x = _v2.a;
		var y = _v2.b;
		return _Utils_Tuple2(
	...
	var r = _v1.a;
	var theta = _v1.b;
	return (_Utils_cmp(r, maxVelocity) < 0) ? _Utils_Tuple2(dx, dy) : _Utils_Tuple2(
		maxVelocity * $elm$core$Basics$cos(theta),
		maxVelocity * $elm$core$Basics$sin(theta));
};
var $author$project$Main$accelerate = function (p) {
	var accelFactor = 1;
	var _v0 = p.velocity;
	var dx = _v0.a;
	var dy = _v0.b;
	var vNext = $author$project$Main$clampV(
		_Utils_Tuple2(
			dx + (accelFactor * $elm$core$Basics$cos(p.theta)),
			dy + (accelFactor * $elm$core$Basics$sin(p.theta))));
	return _Utils_update(
		p,
		{velocity: vNext});
};
...
var $author$project$Main$Torpedo = F4(
	function (position, velocity, created, fromPlayer) {
		return {created: created, fromPlayer: fromPlayer, position: position, velocity: velocity};
	});
var $author$project$Main$makeTorpedo = F4(
	function (fromPlayer, time, _v0, theta) {
		var x = _v0.a;
		var y = _v0.b;
		var torpedoSpeed = 3.0;
		var psn = _Utils_Tuple2(
			x + (20 * $elm$core$Basics$cos(theta)),
			y + (20 * $elm$core$Basics$sin(theta)));
		return A4(
			$author$project$Main$Torpedo,
			psn,
			_Utils_Tuple2(
				torpedoSpeed * $elm$core$Basics$cos(theta),
				torpedoSpeed * $elm$core$Basics$sin(theta)),
			time,
			fromPlayer);
	});
var $author$project$Main$maxPlayerTorpedos = 5;
var $author$project$Main$addPlayerTorpedo = function (model) {
	var count = F2(
		function (p, l) {
			return $elm$core$List$length(
				A2($elm$core$List$filter, p, l));
		});
	var currentPlayerTorpedos = A2(
		count,
		function ($) {
			return $.fromPlayer;
		},
		model.torpedos);
	if (_Utils_cmp(currentPlayerTorpedos, $author$project$Main$maxPlayerTorpedos) > -1) {
		return model;
	} else {
		var b = A4($author$project$Main$makeTorpedo, true, model.time, model.player.position, model.player.theta);
		return _Utils_update(
			model,
			{
				torpedos: A2($elm$core$List$cons, b, model.torpedos)
			});
	}
};
var $elm$core$Basics$neq = _Utils_notEqual;
var $author$project$Main$removeOldTorpedos = function (model) {
	var torpedoLifetime = 60 * 2;
	var isLive = function (b) {
		return _Utils_cmp(model.time - b.created, torpedoLifetime) < 0;
	};
	return _Utils_update(
		model,
		{
			torpedos: A2($elm$core$List$filter, isLive, model.torpedos)
		});
};
var $elm$core$Basics$negate = function (n) {
	return -n;
};
var $author$project$Main$rotatePlayer = F2(
	function (dir, p) {
		var rotationRate = 10;
		var amount = _Utils_eq(dir, $author$project$Main$Left) ? $elm$core$Basics$degrees(-rotationRate) : $elm$core$Basics$degrees(rotationRate);
		return _Utils_update(
			p,
			{theta: p.theta + amount});
	});
...
var $author$project$Main$makeEnemyTorpedos = F2(
	function (time, enemies) {
		var shoot = F2(
			function (i, e) {
				return _Utils_eq(
					i * 300,
					A2($elm$core$Basics$modBy, 900, time | 0)) ? _List_fromArray(
					[
						A4($author$project$Main$makeTorpedo, false, time, e.position, e.theta)
					]) : _List_Nil;
			});
		return $elm$core$List$concat(
			A2($elm$core$List$indexedMap, shoot, enemies));
	});
...
var $author$project$Main$moveEnemy = function (e) {
	var deltaOmega = $elm$core$Basics$degrees(1);
	var toPolar = function (_v1) {
		var x = _v1.a;
		var y = _v1.b;
		return _Utils_Tuple2(
			$elm$core$Basics$sqrt(
	...
	var _v0 = toPolar(e.position);
	var r = _v0.a;
	var omega = _v0.b;
	var omegaNext = omega + ((deltaOmega * $author$project$Main$width) / (4 * r));
	return _Utils_update(
		e,
		{
			position: _Utils_Tuple2(
				r * $elm$core$Basics$cos(omegaNext),
				r * $elm$core$Basics$sin(omegaNext))
		});
};
...
var $author$project$Main$updateEnemies = function (model) {
	var d = F2(
		function (b, e) {
			return A2($author$project$Main$distance, b.position, e.position);
		});
	var dSun = function (b) {
		return A2(
	...
	var enemiesNext = A2(
		...
		function (e) {
			return A2(closest, e, model.torpedos) > 10;
		},
		model.enemies);
	var torpedosNext = A2(
		$elm$core$List$filter,
		function (b) {
			return (A2(closest, b, model.enemies) > 10) && (dSun(b) > 10);
		},
		model.torpedos);
	var enemiesMotion = A2(
		$elm$core$List$map,
		A2(
			$elm$core$Basics$composeR,
			$author$project$Main$facePoint(model.player.position),
			$author$project$Main$moveEnemy),
		enemiesNext);
	var newTorpedos = A2($author$project$Main$makeEnemyTorpedos, model.time, enemiesMotion);
	return _Utils_update(
		model,
		{
			enemies: enemiesMotion,
			torpedos: _Utils_ap(torpedosNext, newTorpedos)
		});
};
var $author$project$Main$Lose = function (a) {
	return {$: 'Lose', a: a};
};
...
var $author$project$Main$updateGameState = function (_v0) {
	var player = _v0.player;
	var torpedos = _v0.torpedos;
	var enemies = _v0.enemies;
	var torpedo_hits = A2(
		$elm$core$List$any,
		function (b) {
			return A2($author$project$Main$distance, player.position, b.position) < 10;
		},
		torpedos);
	var enemy_hits = A2(
		$elm$core$List$any,
		function (e) {
			return A2($author$project$Main$distance, player.position, e.position) < 10;
		},
		enemies);
	var sun_hit = A2(
		$author$project$Main$distance,
		player.position,
		_Utils_Tuple2(0, 0)) < 10;
	return torpedo_hits ? $author$project$Main$Lose('You were destroyed by a torpedo!') : (enemy_hits ? $author$project$Main$Lose('You were destroyed in a collision!') : (sun_hit ? $author$project$Main$Lose('Your ship was consumed by a star!') : ((!$elm$core$List$length(enemies)) ? $author$project$Main$Win : $author$project$Main$Playing)));
};
var $author$project$Main$height = 800;
var $author$project$Main$updatePosition = F2(
	function (_v0, _v1) {
		var px = _v0.a;
		var py = _v0.b;
		var dx = _v1.a;
		...
		var wrapCoords = function (_v2) {
			var x = _v2.a;
			var y = _v2.b;
			return _Utils_Tuple2(
				A2(wrap, x, $author$project$Main$width / 2),
				A2(wrap, y, $author$project$Main$height / 2));
		};
		return wrapCoords(
			_Utils_Tuple2(px + dx, py + dy));
	});
var $author$project$Main$updateVelocity = F2(
	function (_v0, _v1) {
		var x = _v0.a;
		var y = _v0.b;
		var dx = _v1.a;
		var dy = _v1.b;
		var gravity = 350;
		var factor = gravity / A2(
			$elm$core$Basics$pow,
			A2($elm$core$Basics$pow, x, 2) + A2($elm$core$Basics$pow, y, 2),
			1.5);
		return $author$project$Main$clampV(
			_Utils_Tuple2(dx - (factor * x), dy - (factor * y)));
	});
var $author$project$Main$updatePlayer = function (p) {
	var pNext = A2($author$project$Main$updatePosition, p.position, p.velocity);
	var vNext = A2($author$project$Main$updateVelocity, p.position, p.velocity);
	return _Utils_update(
		p,
		{position: pNext, velocity: vNext});
};
var $author$project$Main$updateTorpedo = function (b) {
	var pNext = A2($author$project$Main$updatePosition, b.position, b.velocity);
	var vNext = A2($author$project$Main$updateVelocity, b.position, b.velocity);
	return _Utils_update(
		b,
		{position: pNext, velocity: vNext});
};
var $author$project$Main$update = F2(
	function (msg, model) {
		if (_Utils_eq(model.state, $author$project$Main$Start)) {
			if (msg.$ === 'Restart') {
				return _Utils_Tuple2(
					$author$project$Main$init($author$project$Main$Playing),
					$elm$core$Platform$Cmd$none);
			} else {
				return _Utils_Tuple2(model, $elm$core$Platform$Cmd$none);
			}
		} else {
			if ((!_Utils_eq(model.state, $author$project$Main$Playing)) && (!_Utils_eq(msg, $author$project$Main$Restart))) {
				return _Utils_Tuple2(model, $elm$core$Platform$Cmd$none);
			} else {
				switch (msg.$) {
					case 'Accelerate':
						return _Utils_Tuple2(
							_Utils_update(
								model,
								{
									player: $author$project$Main$accelerate(model.player)
								}),
							$elm$core$Platform$Cmd$none);
					case 'Rotate':
						var dir = msg.a;
						return _Utils_Tuple2(
							_Utils_update(
								model,
								{
									player: A2($author$project$Main$rotatePlayer, dir, model.player)
								}),
							$elm$core$Platform$Cmd$none);
					case 'Shoot':
						return _Utils_Tuple2(
							$author$project$Main$addPlayerTorpedo(model),
							$elm$core$Platform$Cmd$none);
					case 'Frame':
						var m = $author$project$Main$updateEnemies(
							$author$project$Main$removeOldTorpedos(model));
						return _Utils_Tuple2(
							{
								enemies: m.enemies,
								player: $author$project$Main$updatePlayer(m.player),
								state: $author$project$Main$updateGameState(m),
								time: m.time + 1,
								torpedos: A2($elm$core$List$map, $author$project$Main$updateTorpedo, m.torpedos)
							},
							$elm$core$Platform$Cmd$none);
					case 'Restart':
						return _Utils_Tuple2(
...
var $author$project$Main$starPositions = _List_fromArray(
	[
		_Utils_Tuple2(115, 155),
		_Utils_Tuple2(349, 433),
		_Utils_Tuple2(673, 244),
		_Utils_Tuple2(197, 705),
		_Utils_Tuple2(285, 419),
		_Utils_Tuple2(620, 371),
		_Utils_Tuple2(197, 702),
		_Utils_Tuple2(189, 776),
		_Utils_Tuple2(91, 320),
		_Utils_Tuple2(195, 223),
		_Utils_Tuple2(342, 778),
		_Utils_Tuple2(113, 726),
		_Utils_Tuple2(573, 291),
		_Utils_Tuple2(48, 435),
		_Utils_Tuple2(120, 721),
		_Utils_Tuple2(788, 591),
		_Utils_Tuple2(531, 21),
		_Utils_Tuple2(13, 20),
		_Utils_Tuple2(351, 5),
		_Utils_Tuple2(130, 385),
		_Utils_Tuple2(66, 424),
		_Utils_Tuple2(322, 752),
		_Utils_Tuple2(383, 330),
		_Utils_Tuple2(85, 364),
		_Utils_Tuple2(677, 602),
		_Utils_Tuple2(792, 650),
		_Utils_Tuple2(732, 496),
		_Utils_Tuple2(730, 380),
		_Utils_Tuple2(421, 115),
		_Utils_Tuple2(611, 70),
		_Utils_Tuple2(735, 157),
		_Utils_Tuple2(447, 356),
		_Utils_Tuple2(112, 6),
		_Utils_Tuple2(626, 74),
		_Utils_Tuple2(486, 666),
		_Utils_Tuple2(416, 793),
		_Utils_Tuple2(141, 302),
		_Utils_Tuple2(407, 45),
		_Utils_Tuple2(779, 750),
		_Utils_Tuple2(754, 265),
		_Utils_Tuple2(706, 592),
		_Utils_Tuple2(258, 71),
		_Utils_Tuple2(448, 258),
		_Utils_Tuple2(458, 782),
		_Utils_Tuple2(771, 767),
		_Utils_Tuple2(751, 705),
		_Utils_Tuple2(239, 186),
		_Utils_Tuple2(542, 381),
		_Utils_Tuple2(696, 305),
		_Utils_Tuple2(148, 402)
	]);
...
var $author$project$Main$background = function () {
	...
	return A2(
		...
		A2(
			$elm$core$List$map,
			function (p) {
				return A3($joakin$elm_canvas$Canvas$rect, p, starSize, starSize);
			},
			$author$project$Main$starPositions));
}();
...
var $author$project$Main$gameFont = function (size) {
	return _List_fromArray(
		[
			$joakin$elm_canvas$Canvas$Settings$fill($avh4$elm_color$Color$white),
			$joakin$elm_canvas$Canvas$Settings$Text$font(
			{family: 'sans-serif', size: size}),
...
var $author$project$Main$header = function (model) {
	var playerTorpedos = $elm$core$String$fromInt(
		function (x) {
			return $author$project$Main$maxPlayerTorpedos - x;
		}(
			$elm$core$List$length(
				A2(
					...
					model.torpedos))));
	var enemies = $elm$core$String$fromInt(
		$elm$core$List$length(model.enemies));
	var positions = _List_fromArray(
		[
			_Utils_Tuple2($author$project$Main$centerX - 300, 50),
			_Utils_Tuple2($author$project$Main$centerY + 300, 50)
		]);
	var lines = _List_fromArray(
		['Enemies: ' + enemies, 'Torpedoes: ' + playerTorpedos]);
	return A3(
		$elm$core$List$map2,
		$joakin$elm_canvas$Canvas$text(
			$author$project$Main$gameFont(18)),
		positions,
		lines);
};
...
var $author$project$Main$renderEnemy = function (e) {
	var transl = function (_v0) {
		var x = _v0.a;
		var y = _v0.b;
		return A2($joakin$elm_canvas$Canvas$Settings$Advanced$translate, x + $author$project$Main$centerX, y + $author$project$Main$centerY);
	};
	return A2(
		$joakin$elm_canvas$Canvas$shapes,
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						transl(e.position),
						$joakin$elm_canvas$Canvas$Settings$Advanced$rotate(e.theta)
					])),
...
var $author$project$Main$renderPlayer = function (p) {
	var transl = function (_v0) {
		var x = _v0.a;
		var y = _v0.b;
		return A2($joakin$elm_canvas$Canvas$Settings$Advanced$translate, x + $author$project$Main$centerX, y + $author$project$Main$centerY);
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						transl(p.position),
						$joakin$elm_canvas$Canvas$Settings$Advanced$rotate(p.theta)
					])),
...
var $author$project$Main$renderTorpedo = F2(
	function (time, _v0) {
		var position = _v0.position;
		var torpedoSize = 3;
		var transl = function (_v1) {
			var x = _v1.a;
			var y = _v1.b;
			return A2($joakin$elm_canvas$Canvas$Settings$Advanced$translate, x + $author$project$Main$centerX, y + $author$project$Main$centerY);
		};
		var hue = A2(
			...
			25,
			$elm$core$Basics$floor(time)) / 100;
		return A2(
			$joakin$elm_canvas$Canvas$shapes,
			_List_fromArray(
				[
					$joakin$elm_canvas$Canvas$Settings$fill(
					A3($avh4$elm_color$Color$hsl, 0, 0.7, 0.5 + hue)),
					$joakin$elm_canvas$Canvas$Settings$Advanced$transform(
					_List_fromArray(
						[
							transl(position)
...
var $author$project$Main$sun = function () {
	var sunSize = 15;
	return A2(
		$joakin$elm_canvas$Canvas$shapes,
		_List_fromArray(
...
var $author$project$Main$textBox = function (g) {
	var positions = _List_fromArray(
		[
			_Utils_Tuple2($author$project$Main$centerX, $author$project$Main$centerY - 200),
			_Utils_Tuple2($author$project$Main$centerX, $author$project$Main$centerY - 100)
		]);
	var lines = function () {
		switch (g.$) {
			case 'Start':
			...
			default:
				var reason = g.a;
				return _List_fromArray(
					[reason, 'Press Enter to play again.']);
		}
	}();
	return A3(
		$elm$core$List$map2,
		$joakin$elm_canvas$Canvas$text(
			$author$project$Main$gameFont(24)),
		positions,
		lines);
};
var $author$project$Main$titleCard = function () {
	var offset = function (u) {
		return _Utils_Tuple2($author$project$Main$centerX, $author$project$Main$centerY - u);
	};
	var title = A3(
		$joakin$elm_canvas$Canvas$text,
		$author$project$Main$gameFont(24),
	...
	var positions = A2(
		...
		_List_fromArray(
			[200, 175, 150, 125]));
	var lines = _List_fromArray(
		['A / D: Rotate the ship left/right.', 'W: Fire thrusters.', 'S / Space: Launch a torpedo.', 'Enter: Play / Restart']);
	var instructions = A3(
		$elm$core$List$map2,
		$joakin$elm_canvas$Canvas$text(
			$author$project$Main$gameFont(18)),
		positions,
		lines);
	return A2($elm$core$List$cons, title, instructions);
}();
...
var $author$project$Main$view = function (model) {
	var torpedos = A2(
		$elm$core$List$map,
		$author$project$Main$renderTorpedo(model.time),
		model.torpedos);
	var player = $author$project$Main$renderPlayer(model.player);
	var enemies = A2($elm$core$List$map, $author$project$Main$renderEnemy, model.enemies);
	var text = $author$project$Main$textBox(model.state);
	var score = $author$project$Main$header(model);
	var title = function () {
		var _v0 = model.state;
		if (_v0.$ === 'Start') {
			return $author$project$Main$titleCard;
		} else {
			return _List_Nil;
		}
	}();
	var renders = _Utils_ap(
		_List_fromArray(
			[$author$project$Main$clearScreen, $author$project$Main$background, player]),
		_Utils_ap(
			enemies,
			_Utils_ap(
				torpedos,
				_Utils_ap(
					_List_fromArray(
						[$author$project$Main$sun]),
					_Utils_ap(
						score,
						_Utils_ap(text, title))))));
	return A2(
		$elm$html$Html$div,
		_List_fromArray(
			[
...
var $author$project$Main$main = $elm$browser$Browser$element(
	{
		init: function (_v0) {
			return _Utils_Tuple2(
				$author$project$Main$init($author$project$Main$Start),
				$elm$core$Platform$Cmd$none);
		},
